...
#define data_size 6                                //how much data is required from the 
...
void setup() 
    {
        ...
        range_msg7.header.frame_id="back_right";
        range_msg7.range=0.0;
        range_msg7.radiation_type=1;
        range_msg7.field_of_view=15;
        range_msg7.min_range=2;
        range_msg7.max_range=400.;
